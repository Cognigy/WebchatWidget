...
export interface IMessengerListTemplateProps
...
export const getMessengerListTemplate = ({
  React,
  styled,
}: MessagePluginFactoryProps) => {
  const MessengerListTemplateHeaderElement =
    getMessengerListTemplateHeaderElement({ React, styled });
  const MessengerFrame = getMessengerFrame({ React, styled });
  const MessengerListTemplateElement = getMessengerListTemplateElement({
    React,
    styled,
  });
  ...
  const MessengerListTemplate = ({
    ...
    const showTopElementLarge =
      top_element_style === "large" || top_element_style === true;
