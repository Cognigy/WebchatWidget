...
export const getMessengerTextWithQuickReplies = ({
  ...
  const MessengerTextWithQuickReplies = ({
    ...
    return (
      <div {...divProps} className="messenger-quick-reply">
        <BorderBubble
          className="messenger-quick-reply-header-message"
          dangerouslySetInnerHTML={{ __html: text }}
        ></BorderBubble>

        {hasQuickReplies && (
          <QuickReplies className="messenger-quick-reply-replies">
            {(quick_replies as IFBMQuickReply[]).map((quickReply, index) => {
              ...
              return (
                <MessengerQuickReply
                  ...
                  className="messenger-quick-reply-reply-container"
                >
                  {image}
