...
const componentStyles = ({
	...
	const isSelected =
		selectedOptionIndex !== undefined && index !== undefined && selectedOptionIndex === index;
...
export const getMessengerQuickReply = ({ React, styled }: MessagePluginFactoryProps) => {
	const MessengerQuickReply = styled.button<{ selectedOptionIndex?: number; index?: number }>(
		componentStyles,
		{
			minHeight: 40,
		},
...
export const getMessengerPhoneNumberQuickReply = ({ React, styled }: MessagePluginFactoryProps) => {
    ...
    const MessengerPhoneNumberQuickReply = styled.a<{
		selectedOptionIndex?: number;
		index?: number;
	}>(componentStyles, {
        minHeight: 30,
