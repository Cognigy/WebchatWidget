...
var utf8 = __webpack_require__(382);

var base64encoder;
if (global && global.ArrayBuffer) {
  base64encoder = __webpack_require__(153);
}
...
var hasCORS = __webpack_require__(365);
...
var debug = __webpack_require__(375)('socket.io-parser');
var json = __webpack_require__(367);
...
var XMLHttpRequest = __webpack_require__(96);
var XHR = __webpack_require__(359);
var JSONP = __webpack_require__(358);
var websocket = __webpack_require__(360);
...
var Transport = __webpack_require__(95);
...
var eio = __webpack_require__(355);
var Socket = __webpack_require__(142);
var Emitter = __webpack_require__(48);
var parser = __webpack_require__(98);
var on = __webpack_require__(141);
var bind = __webpack_require__(99);
var debug = __webpack_require__(68)('socket.io-client:manager');
var indexOf = __webpack_require__(137);
...
var on = __webpack_require__(141);
var bind = __webpack_require__(99);
var debug = __webpack_require__(68)('socket.io-client:socket');
var hasBin = __webpack_require__(136);
...
var client_1 = __webpack_require__(150);
var _window = window,
...
var CognigyWebClient = function (_client_1$CognigyClie) {
    _inherits(CognigyWebClient, _client_1$CognigyClie);

    function CognigyWebClient(options) {
        _classCallCheck(this, CognigyWebClient);

        var _this = _possibleConstructorReturn(this, (CognigyWebClient.__proto__ || Object.getPrototypeOf(CognigyWebClient)).call(this, options));

        _this.voices = [];
        _this.currentVoice = null;
        _this.recognizer = null;
        _this.recognizing = false;
        _this.finalTranscript = "";
        _this.language = options.language;
        _this.onRecEnd = null;
        _this.onInterim = null;
    ...
    _createClass(CognigyWebClient, [{
        key: "initSpeechSynthesis",
        value: function initSpeechSynthesis(language, voiceName) {
           return;
        }
    }, {
        key: "initSpeechRecognigition",
        value: function initSpeechRecognigition() {
            var _this2 = this;
            ...
            this.recognizer.onend = function () {
                ...
                _this2.recognizer.stop();
                if (_this2.onRecEnd !== null && _this2.onRecEnd !== undefined && typeof _this2.onRecEnd === "function") _this2.onRecEnd(_this2.finalTranscript);
            };
            this.recognizer.onresult = function (event) {
                ...
                for (var i = event.resultIndex; i < event.results.length; ++i) {
                    ...
                    if (event.results[i].isFinal) {
                        _this2.finalTranscript += event.results[i][0].transcript;
                        _this2.finalTranscript = _this2.finalTranscript.replace(firstChar, function (m) {
                            return m.toUpperCase();
                        });
                    }
                }
                if (_this2.onInterim !== null && _this2.onInterim !== undefined && typeof _this2.onInterim === "function") _this2.onInterim(transcript);
            };
        }
        /**
        ...
        value: function say(message) {
            var vsmg = new SpeechSynthesisUtterance();
        ...
        key: "registerOnRecEnd",
        value: function registerOnRecEnd(onRecEnd) {
        ...
        key: "registerOnInterim",
        value: function registerOnInterim(onInterim) {
        ...
        value: function toggleRec(lang) {
			...
			/* Check if the recognizer exists */
			if (!this.recognizer) {
				console.error("ERROR: Speech recognition is not supported in this browser");
				return;
			}
    ...
    return CognigyWebClient;
}(client_1.CognigyClient);

exports.CognigyWebClient = CognigyWebClient;
...
Object.defineProperty(exports, "__esModule", { value: true });
var sio = __webpack_require__(369);
...
var CognigyClient = function () {
     ...
     */
    function CognigyClient(options) {
        var _this = this;

        _classCallCheck(this, CognigyClient);
        ...
        this.firstLoad = true;
        this.messageBuffer = [];
        if (options.keepMarkup === undefined) this.options.keepMarkup = false;
        if (options.reconnection === undefined) this.options.reconnection = true;
        if (options.interval === undefined) this.options.interval = 10000;
        if (options.expiresIn === undefined) this.options.expiresIn = null;
                ...
                if (!_this.isConnected()) {
                    ...
                    return _this.connect().then(function () {
                        ...
                        if (_this.messageBuffer.length > 0) {
                            ...
                            try {
                                for (var _iterator = _this.messageBuffer[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                                    var msg = _step.value;

                                    _this.sendMessage(msg.text, msg.data);
                                }
                            } catch (err) {
                            ...
                            console.log("[Client] Finished sending " + _this.messageBuffer.length + " buffered messages.");
                            _this.messageBuffer = [];
                        }
                    }).catch(function (err) {
    ...
    _createClass(CognigyClient, [{
        key: "connect",
        value: function connect() {
            var _this2 = this;

            var currentToken = void 0;
            return this.getToken(this.options.baseUrl, this.options.user, this.options.apikey, this.options.channel, this.options.token).then(function (token) {
                return _this2.establishSocketConnection(token);
        ...
        key: "resetFlow",
        value: function resetFlow(newFlowId, language, version) {
            var _this3 = this;

            return new Promise(function (resolve, reject) {
                if (!_this3.isConnected()) {
                    var error = "[Client] Error resetting flow. You are not connected to the CAI-server.";
                    console.error(error);
                    return reject(error);
                }
                _this3.updateLastUsed();
        ...
        value: function resetState() {
            ...
            return new Promise(function (resolve, reject) {
                if (!_this4.isConnected()) {
                    var error = "[Client] Error resetting state. You are not connected to the CAI-server.";
                    console.error(error);
                    return reject(error);
                }
                _this4.updateLastUsed();
                _this4.mySocket.emit("resetState", function (currentState) {
        ...
        value: function resetContext() {
            ...
            return new Promise(function (resolve, reject) {
                if (!_this5.isConnected()) {
                    var error = "[Client] Error resetting context. You are not connected to the CAI-server.";
                    console.error(error);
                    return reject(error);
                }
                _this5.updateLastUsed();
                _this5.mySocket.emit("resetContext", function (currentContext) {
        ...
        value: function injectContext(context) {
            ...
            return new Promise(function (resolve, reject) {
                if (!_this6.isConnected()) {
                    var error = "[Client] Error injecting context. You are not connected to the CAI-server.";
                    console.error(error);
                    return reject(error);
                }
                if ((typeof context === "undefined" ? "undefined" : _typeof(context)) !== 'object') {
                    ...
                    try {
                        ...
                        var _error = "[Client] Error injecting context. The passed context is not JSON.";
                        console.error(_error);
                        return reject(_error);
                    }
                }
                _this6.updateLastUsed();
                _this6.mySocket.emit("injectContext", context, function (newContext) {
                    resolve(newContext);
                });
            });
        }
        ...
        value: function injectState(state) {
            ...
            return new Promise(function (resolve, reject) {
                if (!_this7.isConnected()) {
                    var error = "[Client] Error injecting state. You are not connected to the CAI-server.";
                    console.error(error);
                    return reject(error);
                }
                if (typeof state !== 'string') {
                    // passed state is not a string
                    var _error2 = "[Client] Error injecting state. The passed state is not a string.";
                    console.error(_error2);
                    return reject(_error2);
                }
                _this7.updateLastUsed();
                _this7.mySocket.emit("injectState", state, function (newState) {
                    resolve(newState);
                });
            });
        }
        ...
        value: function on(event, handler) {
            ...
            } else console.log("[Client] Unable to subscribe on socket.io-event. Currently not connected to a CAI-server.");
        }
        /**
        ...
        key: "sendEvent",
        value: function sendEvent(event, data, callback) {
            if (this.isConnected()) {
                this.updateLastUsed();
                callback ? this.mySocket.emit(event, data, callback) : this.mySocket.emit(event, data);
            } else console.log("[Client] Unable to send event. Currently not connected to a CAI-server.");
        }
        /**
        ...
        value: function isExpired() {
            if (this.options.expiresIn === null) return false;
            return Date.now() - this.lastUsed > this.options.expiresIn;
        }
    }, {
        key: "establishSocketConnection",
        value: function establishSocketConnection(token) {
            var _this8 = this;
            ...
            this.mySocket.on("error", function (error) {
                _this8.options.handleError ? _this8.options.handleError(error) : console.log(error);
            });
            this.mySocket.on("exception", function (error) {
                _this8.options.handleException ? _this8.options.handleException(error) : console.log(error);
            });
            this.mySocket.on("output", function (output) {
                if (!_this8.options.keepMarkup) {
                    output.text = output && output.text && typeof output.text === "string" ? output.text.replace(/<[^>]*>/g, "") : output.text;
                }
                _this8.options.handleOutput ? _this8.options.handleOutput(output) : console.log("Text: " + output.text + " Data: " + output.data);
            });
            this.mySocket.on("logStep", function (data) {
                _this8.options.handleLogstep ? _this8.options.handleLogstep(data) : null;
            });
            this.mySocket.on("logStepError", function (data) {
                _this8.options.handleLogstepError ? _this8.options.handleLogstepError(data) : null;
            });
            this.mySocket.on("logFlow", function (data) {
                _this8.options.handleLogflow ? _this8.options.handleLogflow(data) : null;
            });
            this.mySocket.on("finalPing", function (finalPing) {
                _this8.options.handlePing ? _this8.options.handlePing(finalPing) : console.log("PING");
            });
            return new Promise(function (resolve, reject) {
                _this8.mySocket.on("connect", function () {
                    resolve(_this8.mySocket);
                });
                _this8.mySocket.on("connect_error", function () {
                    reject(new Error("Error connecting"));
                });
                _this8.mySocket.on("connect_timeout", function () {
                    reject(new Error("Error connecting"));
                });
            });
        }
        ...
        key: "getToken",
        value: function getToken(baseUrl, user, apikey, channel, token) {
            var _this9 = this;

            if (token) return Promise.resolve(token);else return fetch(baseUrl + "/loginDevice", {
                headers: {
                ...
                if (response.token) return Promise.resolve(response.token);else return Promise.reject(new Error("Unexptected error since no token was supplied as part of the response."));
            });
        }
    }, {
        key: "updateLastUsed",
...
exports.CognigyClient = CognigyClient;
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(13)(proto, TO_PRIMITIVE, __webpack_require__(158));
...
var parser = __webpack_require__(47);
var parseuri = __webpack_require__(138);
...
Socket.Transport = __webpack_require__(95);
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(383);
  } catch (e) { }
}
...
;(function () {
  ...
  var isLoader = "function" === "function" && __webpack_require__(380);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(144)(module), __webpack_require__(10)))
...
var url = __webpack_require__(370);
var parser = __webpack_require__(98);
var Manager = __webpack_require__(140);
var debug = __webpack_require__(68)('socket.io-client');
...
exports.Socket = __webpack_require__(142);
...
var parseuri = __webpack_require__(138);
var debug = __webpack_require__(68)('socket.io-client:url');
