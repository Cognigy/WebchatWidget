...
export const setFullscreenMessage = (
  fullscreenMessage: IMessage | undefined
) => ({
...
type SetAgentAvatarOverrideUrlAction = ReturnType<
  typeof setAgentAvatarOverrideUrl
>;
...
type SetUserAvatarOverrideUrlAction = ReturnType<
  typeof setUserAvatarOverrideUrl
>;
...
export const ui: Reducer<UIState, UIAction> = (
