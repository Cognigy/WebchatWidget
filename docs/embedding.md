...
| useDefaultReplyCompatibilityMode       | boolean                              | false                 |                              |                                       |                                 | A hotfix to avoid breaking the Webchat Widget when using default replies in intents. Enable it to avoid breaking, but be aware that it might decrease the performance and it will be removed in upcoming versions when the main issue is solved in Cognigy.AI                                                                                                                            |
