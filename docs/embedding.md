...
| ratingMessageHistoryCommentText    | string                              | "You commented:"|                               |                                       |                                 | The text displayed in the message history after giving a rating, if there was a comment sent (test is followed by the actual comment) |
