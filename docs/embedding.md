...
| dynamicImageAspectRatio             | boolean                             | false                              | x                              |                                       |                                 | If true, images from the "gallery", "attachment" or "top list item" template will not have a forced aspect ratio and will be fully displayed full-width without cropping                                        |
| enableConnectionStatusIndicator     | boolean                             | true                               | x                              |                                       |                                 | Whether to show a warning if the connection is lost during a conversation. The warning will disappear when the connection is re-established.                                                                    |
...
| enableGenericHTMLStyling            | boolean                             | false                              | x                              |                                       |                                 | If true, will apply generic CSS styling rules to the HTML content of regular text messages                                                                                                                      |
| enableInputCollation                | boolean                             | true                              | x                               |                                       |                                 | If true, will artificially delay messages written via the regular text input and will combine and send them as one collated message after 1 second of inactivity                                                |
...
| enableUnreadMessageBadge            | boolean                             | false                              | x                              |                                       |                                 | If true, the webchat shows a badge with the number of unread messages at the toggle button                                                                                                                      |
| enableUnreadMessagePreview          | boolean                             | false                              | x                              |                                       | x                               | If true, the webchat shows a message bubble with the latest retrieved bot message.                                                                                                                              |
| enableUnreadMessageSound            | boolean                             | false                              | x                             | x                                      |                                 | If true, plays a notification sound for each incoming unread message                                                                                                                                            |
| enableUnreadMessageTitleIndicator   | boolean                             | false                              | x                              |                                       |                                 | If true, will indicate the amount of unread messages in the page title every 1000ms                                                                                                                             |
| engagementMessageText               | string                              | ""                                 |                               |                                       |                                 | The text of the message to display next to the webchat icon to get the user to engage.                                                                                                                          |
| focusInputAfterPostback             | boolean                             | false                              | x                              |                                       |                                 | If true, the message input field will receive focus after a Postback button or quick reply button is clicked                                                                                                    |
...
| showEngagementMessagesInChat        | boolean                             | false                              | x                              |                                       |                                 | If this is true, then engagement messages will also be shown in the chat window                                                                                                                                 |
